 ...
 * @version: V1.0
 * 日期:2017年5月8日 下午6:02:54  
 */
public class PBBD09Util {
     ...
     * @return
     */
    public static double[] LatLng2Mercator(double x, double y){
        double[] arr = null;
        double n_lat = y > 74 ? 74 : y;
     ...
     * @return
     */
    public static double[] Mercator2LatLng(double x, double y)
    {
        double[] arr = null;
       ...
       double[] res = Convertor(x_abs, y_abs, arr);
       return res;
    }
     ...
     * @return
     */
    public static int[] GetTileXYIndexByXY(double x ,double y,int zoom){
        double[] bdMercatorXY = LatLng2Mercator(x,y);
        int xTileXY = (int)(bdMercatorXY[0]/Math.pow(2,18-zoom));
        int yTileXY = (int)(bdMercatorXY[1]/Math.pow(2,18-zoom));
        return new int[]{(xTileXY/256),(yTileXY/256)};
    }
}
